...
#ifdef DLL_EXPORTS
#define PQ10_API __declspec(dllexport)
#define DECL_SPEC __declspec(dllexport)
#else
#define PQ10_API __declspec(dllimport)
...
//
//  DESCRIPTION:  Register app function to call to register link error callback
//
//  PARAMETERS:   LOGFPTR CallbackPointer: function to call to perform logging
//
//  RETURNS:	nothing
...
DECL_SPEC bool CALL_CONV LoopTest(API_DEVICE_HANDLE Handle, U8 StartValue, U16 Count);
