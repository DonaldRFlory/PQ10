...
//End Lead-in code file LWPart1.CS ---------------------------
		...
		private U8 MasterBlockDown(DOWN_PTR_U8[] SrcPtr, U8 Count, U32 DestAddress)
		{
			return LINK.MasterBlockDown(CMgr.CurHandle(), SrcPtr, Count, DestAddress);
		}

		private U8 MasterBlockUp(U32 SrcAddress, UP_PTR_U8[] DestPtr, U8 Count)
		{
		...
		private U8 SetSlaveParameter(U8 ParCode, U32 Param)
		{
			return LINK.SetSlaveParameter(CMgr.CurHandle(), ParCode, Param);
		}

		private U16 TraceBufferCount()
		{
			return LINK.TraceBufferCount(CMgr.CurHandle());
		}
		...
		private void Dummy2(UP_PTR_U8[] TraceValsPtr, U8 TraceValCount)
		{
			LINK.Dummy2(CMgr.CurHandle(), TraceValsPtr, TraceValCount);
		}

		static class LINK
		{
			[DllImport(@".\PQ10API.dll")]
			public static extern U8 MasterBlockDown(API_DEVICE_HANDLE Handle, DOWN_PTR_U8[] SrcPtr, U8 Count, U32 DestAddress);
			[DllImport(@".\PQ10API.dll")]
			public static extern U8 MasterBlockUp(API_DEVICE_HANDLE Handle, U32 SrcAddress, UP_PTR_U8[] DestPtr, U8 Count);
			[DllImport(@".\PQ10API.dll")]
			public static extern U32 GetSlaveParameter(API_DEVICE_HANDLE Handle, U8 ParCode, U8 Index);
			[DllImport(@".\PQ10API.dll")]
			public static extern U8 SetSlaveParameter(API_DEVICE_HANDLE Handle, U8 ParCode, U32 Param);
			[DllImport(@".\PQ10API.dll")]
			public static extern U16 TraceBufferCount(API_DEVICE_HANDLE Handle);
			[DllImport(@".\PQ10API.dll")]
			public static extern U8 ReadTraceBuffer(API_DEVICE_HANDLE Handle, UP_PTR_U8[] TraceValsPtr, U8 TraceValCount);
			[DllImport(@".\PQ10API.dll")]
			public static extern void Dummy2(API_DEVICE_HANDLE Handle, UP_PTR_U8[] TraceValsPtr, U8 TraceValCount);
		}
	}
}
