...
//Functions for building menu and testing --------------------------------------------------
		...
		public bool DrawMenu(string MenuName)
		{
			...
			if(TheMenu.MenuDict.TryGetValue(MenuName, out MenuPage))
			{
                ...
                for(int i = 0; i < MenuPage.Items.Count; ++i)
            	{
...
//the following part is generated by ldfutil.exe----------------------------------------
		...
		{
			return (U32)SetSlaveParameter((U8)Par1, (U32)Par2);
		}

		public U32 DTraceBufferCount(U32 Par1, U32 Par2, U32 Par3, U32 Par4)
		{
			return (U32)TraceBufferCount();
		}
		...
		public void InitMenuDelegates()
		{
			...
			AddMenuDelegate("TraceBufferCount", new MenuDelegate(DTraceBufferCount));
